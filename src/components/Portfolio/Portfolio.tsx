...
import nestVista from '../../assets/nestVista-min.png';
import nestVista2 from '../../assets/nestVista2-min.png';
  ...
  return (
    <section id='portfolio' className='mt-12'>
      <Container>
        ...
        <div className='mt-16 relative p-4 w-full mx-auto bg-bgDark2 md:py-12 rounded-xl xl:mt-24'>
          <img src={nestVista2} alt='' className='w-full mx-auto md:hidden' />
          <img
            src={nestVista}
            alt=''
            className='w-full  mx-auto hidden md:block md:w-4/5'
